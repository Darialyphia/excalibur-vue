...
export type UiState = {
  selectedUnitData: Ref<UnitData | null>;
  selectedUnit: ShallowRef<Unit | null>;
...
const uiState: UiState = {
  selectedUnitData: ref(null),
  selectedUnit: shallowRef(null),
  selectUnit(unit) {
    uiState.selectedUnit.value = unit;
    uiState.selectedUnitData.value = null;
  },
  selectUnitData(unitData) {
    if (uiState.selectedUnitData.value === unitData) {
      uiState.selectedUnitData.value = null;
    } else {
      uiState.selectedUnitData.value = unitData;
    }
    ...
    <div class="ui" v-if="isReady">
      <div class="units">
        <UnitButton
          ...
          :unit
          class="ui-component"
          :class="uiState.selectedUnitData.value?.name === unit.name && 'is-selected'"
